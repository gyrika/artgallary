...
function About(){
  return <main className="about-page"><section className="about-hero page-pad"><div><span className="kicker">Artist · Engineer · Observer</span><h1>Structure meets <em>intuition.</em></h1></div><div className="portrait"><div className="portrait-shape"></div><span>In the studio, Colombo · 2025</span></div></section>
    <section className="about-intro page-pad"><span>01 — Biography</span><h2>Rooted in engineering and drawn toward artistic expression, the artist combines structure, geometry and observation with emotion, intuition and symbolic storytelling.</h2><div><p>Piyumini is a Sri Lankan contemporary artist whose work traces the relationship between inner awareness and the environments we inhabit.</p><p>Her engineering background appears not as precision alone, but as an instinct for balance, tension and systems. Against this structure, pigment is allowed to behave unpredictably.</p></div></section>
